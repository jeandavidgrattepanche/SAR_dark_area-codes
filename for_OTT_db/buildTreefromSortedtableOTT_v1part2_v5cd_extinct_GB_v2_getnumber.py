	...
	for ord1, fam in taxo4dict.items():
		...
		for fa in fam:
			if fa not in falist:
				...
				print(number, '-', numberofseq)
				if tree == "":
					try: 
						tree = "("+str(taxo5dict[fa]).split(',')[0].replace("'","").replace('[','').replace(']','').replace('"',"").replace(',',':0,')+":0)"+'{'+str(int(numberofseq))+'}'
					except:
						tree =fa.split(',')[0].replace("'","").replace('[','').replace(']','').replace('"',"").replace(',',':0,')+':0'
				else:
					try: 
						tree = tree+",("+str(taxo5dict[fa]).split(',')[0].replace("'","").replace('[','').replace(']','').replace('"',"").replace(',',':0,')+":0)"+'{'+str(int(numberofseq))+'}'
					except:
...
#					print(ordtree[orde], number)
					if tree1 == "empty":
						try: 
							tree1 = str(ordtree[orde].split('{!')[0])+'{'+str(int(numberofseq))+'}'
...
#							tree = '(' + fa + ')' 
						...
						try: 
							tree1 = tree1+","+str(ordtree[orde].split('{!')[0])+'{'+str(int(numberofseq))+'}'
#							print(tree1)
						except:
							print('error order2')
					...
					if orde not in falist:
						...
						if tree1 == "empty":
							try: 
								tree1 = "("+str(taxo5dict[orde]).split(',')[0].replace("'","").replace('[','').replace(']','').replace('"',"").replace(',',':0,')+":0)"+'{'+str(int(numberofseq))+'}'
							except:
#								tree1 = '(' + orde + ')' 
								print('error fa1')
						else:
							try: 
								tree1 = tree1+",("+str(taxo5dict[orde]).split(',')[0].replace("'","").replace('[','').replace(']','').replace('"',"").replace(',',':0,')+":0)"+'{'+str(int(numberofseq))+'}'
#								print(tree1)
							except:
#								tree1 = tree1+',(' + orde + ')' 
								print('error fa2')
...
#				print(ph1, cle)
				if cle.split('_')[0] == "cl":
					...
					if tree1 == "":
						try: 
							tree1 = str(cltree[cle].split('{!')[0])+'{'+str(int(numberofseq))+'}'
#							print(cle, "=>",tree1)
						except:
							print('error cl1')
#							tree = '(' + fa + ')' 
						...
						try: 
							tree1 = tree1+","+str(cltree[cle].split('{!')[0])+'{'+str(int(numberofseq))+'}'
						except:
							print('error cl2')
					...
					if cle not in ordlist:
						...
						if tree1 == "":
							try: 
								tree1 = "("+str(ordtree[cle].split('{!')[0])+'{'+str(int(numberofseq))+'}'+")"#+cle
#								print(cle, '=>', tree1)
							except:
#								tree1 = '(' + orde + ')' 
								print('error clor1')
							...
							try: 
								tree1 = tree1+",("+str(ordtree[cle].split('{!')[0])+'{'+str(int(numberofseq))+'}'+")"#+cle
							except:
#								tree1 = tree1+',(' + orde + ')' 
								print('error clor2')
					...
					if cle not in falist:
						...
						if tree1 == "":
							try: 
								tree1 = "("+str(taxo5dict[cle]).split(',')[0].replace("'","").replace('[','').replace(']','').replace('"',"").replace(',',':0,')+":0)"+'{'+str(int(numberofseq))+'}'
#								print(cle, '=>', tree1)
							except:
#								tree1 = '(' + orde + ')' 
								print('error clfa1')
							...
							try: 
								tree1 = tree1+",("+str(taxo5dict[cle]).split(',')[0].replace("'","").replace('[','').replace(']','').replace('"',"").replace(',',':0,')+":0)"+'{'+str(int(numberofseq))+'}'
							except:
#								tree1 = tree1+',(' + orde + ')' 
								print('error clfa2')
				else:
...
#				print(ik1, phe)
				if phe.split('_')[0] == "ph":
					...
					if tree1 == "":
						...
						try: 
							tree1 = str(phtree[phe].split('{!')[0])+'{'+str(int(numberofseq))+'}'
						except:
							print('error ph1')
#							tree = '(' + fa + ')' 
					else:
						try: 
							tree1 = tree1+","+str(phtree[phe].split('{!')[0])+'{'+str(int(numberofseq))+'}'
						except:
							print('error ph2')
					...
					if tree1 == "":
						print(ik1)
						try: 
							tree1 = str(cltree[phe].split('{!')[0])+'{'+str(int(numberofseq))+'}'
						except:
							print('error phcl1')
#							tree = '(' + fa + ')' 
					else:
						try: 
							tree1 = tree1+","+str(cltree[phe].split('{!')[0])+'{'+str(int(numberofseq))+'}'
						except:
							print('error phcl2')
					...
					if tree1 == "":
						print(ik1)
						try: 
							tree1 = str(ordtree[phe].split('{!')[0])+'{'+str(int(numberofseq))+'}'
						except:
#							tree1 = '(' + orde + ')' 
							print('error phor1')
					else:
						try: 
							tree1 = tree1+","+str(ordtree[phe].split('{!')[0])+'{'+str(int(numberofseq))+'}'
						except:
#							tree1 = tree1+',(' + orde + ')' 
							print('error phor2')
					...
					if tree1 == "":
						print(ik1)
						try: 
							tree1 = "("+str(taxo5dict[phe]).split(',')[0].replace("'","").replace('[','').replace(']','').replace('"',"").replace(',',':0,')+":0)"+'{'+str(int(numberofseq))+'}'
						except:
#							tree1 = '(' + orde + ')' 
							print('error phfa1')
					else:
						try: 
							tree1 = tree1+",("+str(taxo5dict[phe]).split(',')[0].replace("'","").replace('[','').replace(']','').replace('"',"").replace(',',':0,')+":0)"+'{'++'/'+str(int(numberofseq))+'}'
						except:
#							tree1 = tree1+',(' + orde + ')' 
							print('error phfa2')
				else:
		...
		perc=int(ikseq) #int(iknumber)-int(ikseq)		
		tree2= '(' + tree1 + '){'+str(perc)+'}' #+ ik1
		tree1=""
#		print(tree2)
